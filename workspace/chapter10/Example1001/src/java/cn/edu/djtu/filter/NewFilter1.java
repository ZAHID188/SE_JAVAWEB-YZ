 ...
 */
@WebFilter(filterName = "NewFilter1", urlPatterns = {"/index.jsp"}, dispatcherTypes = {DispatcherType.FORWARD, DispatcherType.ERROR, DispatcherType.REQUEST, DispatcherType.INCLUDE})
public class NewFilter1 implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            System.out.println("在NewFilter1的chain.doFilter(request, response);语句前");
            chain.doFilter(request, response);
            System.out.println("在NewFilter1的chain.doFilter(request, response);语句后");
        } catch (Throwable t) {
