 ...
 */
@WebFilter(filterName = "NewFilter0", urlPatterns = {"*.jsp"})
public class NewFilter0 implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("NewFilter0:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("NewFilter0:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            System.out.println("在NewFilter0的chain.doFilter(request, response);语句前");
            chain.doFilter(request, response);
            System.out.println("在NewFilter0的chain.doFilter(request, response);语句后");
        } catch (Throwable t) {
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("NewFilter0:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("NewFilter0(");
